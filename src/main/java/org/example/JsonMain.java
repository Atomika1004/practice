...
public class JsonMain {
    public static void main(String[] args) {
        ...
        String jsonListStudents = JsonUtil.studentsToJson(students);
        System.out.println(jsonListStudents);

        //блок с универами
        List<University> universities = ReaderXLSX.getUniversitytList();
        String jsonListUniversities = JsonUtil.universitiesToJson(universities);
        System.out.println(jsonListUniversities);
